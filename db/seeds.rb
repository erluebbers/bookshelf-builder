...
List.create(title: "Mieko Kawakami's Best Books", description: "The books that showcase the best of this amazing Japanese writer", genre: "Literary Fiction", creator: "Erik")
List.create(title: "Ishiguro's best", description: "The most impactful Kazuo Ishiguro novels", genre: "Literary Fiction", creator: "Erik")


Booklist.create(book_id: 4, list_id: 1)
Booklist.create(book_id: 5, list_id: 1)
Booklist.create(book_id: 1, list_id: 2)
Booklist.create(book_id: 2, list_id: 2)
Booklist.create(book_id: 3, list_id: 2)
